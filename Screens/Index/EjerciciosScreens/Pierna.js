        ...
        <ScrollView style={styles.content}>
            <View style={styles.contenido}>
                <View style={styles.home}>
                    ...
                    <Text style={styles.des}>Para realizarlo
                        partimos de la posición de pie, separamos
                        ligeramente las piernas y elevamos la
                        rodilla izquierda para aproximarla al
                        codo derecho. </Text>

                    <TouchableOpacity style={styles.button}
                        onPress={() => navigation.navigate('PiernaAux')}>
